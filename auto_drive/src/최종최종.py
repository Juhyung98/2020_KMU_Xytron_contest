...
def start():
	...
	while True:
		...
		if(State == drive_state.drive):
			...
			#--------- staright ---------#
			if abs(angle) <= 20:
				angle = -(Width/2 - center)/3 #lidar_calibration#(calculate_pid (Width/2, center,3.5,0.05,1.3) / 13.0)
